...
make_group(group1_b,
	...
	helper_fun opcode_table[256] = {
		...
		/* 0x8c */ inv, lea_m2r_v, mov_r2s, group6,
		/* 0x90 */ xchg_a2r_v, xchg_a2r_v, xchg_a2r_v, xchg_a2r_v,
		/* 0x94 */ xchg_a2r_v, xchg_a2r_v, xchg_a2r_v, xchg_a2r_v,
		/* 0x98 */ cbw, cwd, inv, inv,
		/* 0x9c */ inv, inv, inv, inv,
		/* 0xa0 */ mov_moffs2a_b, mov_moffs2a_v, mov_a2moffs_b, mov_a2moffs_v,
		/* 0xa4 */ movs_v_b, movs_v_v, inv, inv,
		/* 0xa8 */ test_i2a_b, test_i2a_v, stos_v_b, stos_v_v,
		/* 0xac */ lods_v_b, lods_v_v, scas_v_b, scas_v_v,
		...
		/* 0xc0 */ group2_i_b, group2_i_v, ret_i_w, ret_v_l,
...
helper_fun _2byte_opcode_table[256] = {
	...
	/* 0x44 */ cmove_rm2r_v, inv, cmovbe_rm2r_v, inv,
	/* 0x48 */ cmovs_rm2r_v, cmovns_rm2r_v, inv, inv,
	/* 0x4c */ inv, inv, cmovle_rm2r_v, cmovg_rm2r_v,
